            ...
            <tbody>
              {messages.map((msg, idx) => (
                <tr key={msg._id} className="table-row">
                  <td className="p-3 text-gray-300">{msg.to}</td>
                  <td className="p-3 text-gray-400 text-sm max-w-md truncate">{msg.content}</td>
                  <td className="p-3">
                  ...
                  <td className="p-3 text-gray-400 text-sm">{msg.sentAt ? new Date(msg.sentAt).toLocaleString() : '-'}</td>
                </tr>
              ))}
              {messages.length === 0 && (
